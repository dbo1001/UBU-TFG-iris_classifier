...
\begin{abstract}
Los sistemas de seguridad basados en la biometría han experimentado una gran demanda y están presentes cada vez más en productos cotidianos como \emph{smartphones} y \emph{tablets}.
...
Así mismo, se ahondará en las técnicas existentes para llevar a cabo el proceso de identificación, desde los métodos convencionales usando algoritmos matemáticos hasta los métodos más actuales cómo los algoritmos de \emph{Machine Learninng} y Redes Neuronales.
\end{abstract}
...
\begin{abstract}
Biometric-based security systems have been experienced a boom and are increasingly present in everyday products such as \emph{smartphones} and \emph{tablets}.
